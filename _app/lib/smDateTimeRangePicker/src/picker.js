...
function Calender($timeout,picker){
	...
	return {
      ...
      scope :{
	    ...
	    controllerAs : 'vm',
	    templateUrl:"lib/smDateTimeRangePicker/dist/picker/calender-date.html",/*"picker/calender-date.html", lib/smDateTimeRangePicker/teste.html//*/
...
function DateTimePicker($mdUtil,$mdMedia,$document,picker){
    return {
      ...
      template: '  <md-input-container md-no-float layout="row">'
                +'<div style="margin-left:-57px; margin-top:-15px; margin-bottom:15px;" hide-sm>'
